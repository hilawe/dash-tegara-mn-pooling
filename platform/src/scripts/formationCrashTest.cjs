...
// SIGNER-TO-OWNER AUTHORIZATION parity (pass-7 wave, codexapp major 4): real Platform
...
//      the branch tests cannot see which node was asked about). ----
{
  ...
  // the SHARE CROSS-CHECK (pass-7 wave, codexapp minor 5): status is the documented
